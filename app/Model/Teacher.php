...
class Teacher extends AppModel {
    ...
    function hashVerifycode($data) {        
        if (isset($this->data[$this->name]['user_id']) && isset($this->data[$this->name]['Username']) && isset($this->data[$this->name]['FilterChar']) && isset($this->data[$this->name]['NAnswer']) && isset($this->data[$this->name]['SecretQuestion'])) {

            $this->data[$this->name]['SecretQuestion'] = base64_encode($this->data[$this->name]['SecretQuestion']);
